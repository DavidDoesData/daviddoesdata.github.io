...
This project is an attempt at making a predictive model for NCAA Div I Men's Basketball games. In addition to predicting winners, we want to predict point spreads. The goal is to be more than 52.4% accurate in predictions.
